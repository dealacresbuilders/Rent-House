          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            {blogs.map((post, index) => (
              <Link
                ...
                border border-[#6DE1D2]/30 transition duration-300 hover:-translate-y-1"
              >
                ...
                <div className="p-6">
                  ...
                  bg-[#E6FBF8] text-[#6DE1D2] px-3 py-1 rounded-full mb-3">
                    {post?.Category || post?.category || "General"}
                  </span>

                  <h3 className="text-lg font-semibold text-gray-900 leading-snug mb-3 group-hover:text-[#6DE1D2] transition">
      ...
      {!loading && !error && Array.isArray(blogs) && blogs.length === 0 && (
        <div className="flex flex-col items-center justify-center text-center py-20">
          ...
          <button
            ...
            bg-gradient-to-r from-[#6DE1D2] to-[#4ccfc0] text-white hover:opacity-90 transition"
          >
            Refresh
          </button>
